 ...
 * UserSecurityServiceImpl. Class UserSecurityImpl use Service pattern which describes
 * service layer of application. This class contain general operation to all classes.
 * This interface contain ads methods which perform busness logic all application.
