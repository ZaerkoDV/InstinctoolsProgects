...
/**
 * <p>The interface LinkDAO contain methods ads which realize in class LinkDAOImpl.Class LinkDAOImpl
 * use DAO pattern which describes layer of data access to object. DAO layer perform link between
 * relational and object model. Model for this dao layer describied in class  Link. This interface
 * contain ads methods which intended to access operation with object. Interface produce special
 * operation with object.Base operation (for any object) include as separate interface CommonEntityDAO
 * which extend to this interface.Class use Spring framework to work whith ORM.In particular often
 * use HibernateTemplate for integration Hibernate and Spring technologys. For work with data base
