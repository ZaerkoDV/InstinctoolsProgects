...
/**
 * <p>The interface LinkHistoryDAO contain methods ads which realize in class LinkHistoryDAOImpl.
 * Class LinkHistoryDAOImpl use DAO pattern which describes layer of data access to object. DAO
 * layer perform link between relational and object model. Model for this dao layer describied in
 * class LinkHistory. This interface contain ads methods which intended to access operation with
